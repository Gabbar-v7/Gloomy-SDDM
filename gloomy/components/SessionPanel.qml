...
Item {
    ...
    DelegateModel {
        ...
        delegate: ItemDelegate {
            ...
            contentItem: Text {
                ...
                width: parent.width - padding * 2    // Adjust text width to account for padding
                elide: Text.ElideRight                // Truncate text with ellipsis if it overflows
            }
    ...
    Popup {
        ...
        width: inputWidth * 0.8 + padding * 2    // Make the popup smaller
        height: contentHeight + padding * 2       // Adjust height if necessary
